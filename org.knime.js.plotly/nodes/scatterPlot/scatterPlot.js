...
window.knimePlotlyScatterPlot = (function () {
    ...
    ScatterPlot.getSVG = function () {
        this.Plotly.toImage(this.Plotly.d3.select('#knime-scatter').node(),
    ...
    ScatterPlot.createAllExclusiveSelected = function () {
        var self = this;
    ...
    ScatterPlot.mountAndSubscribe = function () {
        var self = this;
        document.getElementById('knime-scatter').on('plotly_selected', function (plotlyEvent) {
            self.onSelectionChange(plotlyEvent);
        });
        document.getElementById('knime-scatter').on('plotly_deselect', function () {
    ...
    ScatterPlot.onSelectionChange = function (data) {
        ...
        if (knimeService.getGlobalService()) { //prevents boxes going away in single view
            ...
            this.Plotly.restyle('knime-scatter', changeObj);
        }
    };
    ...
    ScatterPlot.updateSelected = function (data) {
        var self = this;
    ...
    ScatterPlot.updateFilter = function (data) {
    ...
    ScatterPlot.getSelectedChangeObject = function (filteredObj) {
        var self = this;
    ...
    ScatterPlot.getFilteredChangeObject = function (keys, pKeys) {
    ...
    ScatterPlot.getEmptyChangeObject = function (pKeys) {
        var self = this;
        var changeObj = {};
    ...
    ScatterPlot.toggleSubscribeToFilters = function () {
    ...
    ScatterPlot.toggleSubscribeToSelection = function () {
    ...
    ScatterPlot.togglePublishSelection = function () {
    ...
    ScatterPlot.toggleShowOnlySelected = function () {
        var changeObj = this.getFilteredChangeObject(
            [this._xAxisCol, this._yAxisCol, 'rowColors', 'rowKeys', 'rowKeys'],
            ['x', 'y', 'marker.color', 'text', 'ids']
        );
                ...
                var xAxisSelection = knimeService.createMenuSelect(
                    ...
                    function () {
                        if (self._xAxisCol !== this.value) {
                            ...
                            self.Plotly.update('knime-scatter', changeObj, layoutObj);
                        }
                    }
                );
                ...
                var tooltipToggleCheckBox = knimeService.createMenuCheckbox(
                    ...
                    function () {
                        if (self._representation.options.tooltipToggle !== this.checked) {
                            ...
                            self.Plotly.relayout('knime-scatter', layoutObj);
                        }
                    },
                    true
                );
